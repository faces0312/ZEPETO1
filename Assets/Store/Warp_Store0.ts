...
export default class Warp_Store0 extends ZepetoScriptBehaviour {
    ...
    OnTriggerEnter(col: Collider) {
        if (col.gameObject.layer == 20) {
            ...
            this.return_Point0_1.gameObject.SetActive(true);
            this.return_Point1_1.gameObject.SetActive(false);
            this.return_Point2_1.gameObject.SetActive(false);
